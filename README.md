...
Tahapan yang dilakukan meliputi eksplorasi data, preprocessing, pelatihan model, evaluasi menggunakan cross validation, hyperparameter tuning, hingga prediksi data testing. 
